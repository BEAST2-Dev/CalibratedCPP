...
/**
 * Function producing an Exponential {@link LifetimeDistribution} value. Because exponential lifetimes
 ...
 */
public class ExpLifetime extends DeterministicFunction<LifetimeDistribution> {
    ...
    public Value<LifetimeDistribution> apply() {
        ...
        return new Value<>(null, LifetimeDistribution.of(new ExponentialDistribution(mean)), this);
    }
}
